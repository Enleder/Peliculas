...
public class main {
    ...
    private static final String nombreArchivo = "C:\\Users\\Usuario\\Desktop\\LaboratorioFinalPeliculas\\peliculas.txt";

    private static final CatalogoPeliculas catalogoPeli = new CatalogoPeliculas();
